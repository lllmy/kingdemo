...
l1 = ["亲亲猪猪宝贝", "幸福的一家", "小毛驴", "甩葱歌", "兔子舞"]
a = "我要听兔子"

all_doc_list = []  # [[ni , de , mingzi , shi , shenme],[ni jinnian jisui le],]
for doc in l1:
...
print(dictionary)  # Dictionary(12 unique tokens: ['什么', '你', '名字', '是', '的']...)
# 词袋的理解
...
# [[(1,1),(4,1),(2,1),(3,1),(0,1)] [1,6,7,5] [1,6,8,5]]
# 语料库:
...
lsi = models.LsiModel(corpus)  # [[(1,1),(4,1),(2,1),(3,1),(0,1)],834473503 [1,6,7,5] [1,6,8,5]]
# [(1,1),(6,1),(5,1)] ..... 89745168268
# 这里的只是需要学习Lsi模型来了解的,这里不做阐述
print("lsi", lsi, type(lsi))
# 语料库corpus的训练结果
print("lsi[corpus]", lsi[corpus])
# 获得语料库doc_test_vec 在 语料库corpus的训练结果 中的 向量表示
print("lsi[doc_test_vec]", lsi[doc_test_vec])  # 5432895982376

# 文本相似度
# 稀疏矩阵相似度 将 主 语料库corpus的训练结果 作为初始值
# lsi[corpus] = [(5,5),(6,7),(9,9),(1,3),(3,8)]
# [(5,5),(6,7),(9,9),(1,3),(3,8)][(3,3)] 边长 or 图形正方形
# 0 [(3,3)]   边长 and 图形正方形
# [(5,5),(6,7),(9,9),(1,3),(3,8)][0] corpus[index]  = [all_doc_list][0] = l1[0]

index = similarities.SparseMatrixSimilarity(lsi[corpus], num_features=len(dictionary.keys()))
print("index", index, type(index))

# index = [[-1.1 , (0.1 , 2.1) , ((3,4,12,9,0.2) ,2) , ((10,20,51,5,0.1),1)]] 185>
# 向量

# 将 语料库doc_test_vec 在 语料库corpus的训练结果 中的 向量表示 与 语料库corpus的 向量表示 做矩阵相似度计算
sim = index[lsi[doc_test_vec]]  # [张云]
